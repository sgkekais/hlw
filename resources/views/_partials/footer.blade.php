    ...
    <div class="container">
        <div class="row pt-4 pb-4">
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled">
                    <li><img src="http://www.bsgdbuv-cup.de/files/bsg-liga-logo-original-png.png" class="bg-white rounded" height="50"> <a href="http://www.bsgdbuv-cup.de/" target="_blank" class="pl-2" title="BSG-Liga">BSG-Cup Düsseldorf</a> <span class="fa fa-fw fa-external-link"></span></li>
                </ul>
