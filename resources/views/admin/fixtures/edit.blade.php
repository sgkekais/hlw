...
@section('content')
    ...
    <form method="POST" action="{{ route('matchweeks.fixtures.update', [$matchweek, $fixture]) }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="matchweek_id" aria-describedby="matchweek_idHelp" value="({{ $matchweek->id }}) Nr. {{ $matchweek->number_consecutive }} | {{ $matchweek->begin ? $matchweek->begin->format('d.m.Y') : null }} - {{ $matchweek->end ? $matchweek->end->format('d.m.Y') : null }}" disabled>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="club_id_home_alt_text" id="club_id_home_alt_text" aria-describedby="club_id_home_alt_textHelp" value="{{ $fixture->club_id_home_alt_text }}">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="club_id_away_alt_text" id="club_id_away_alt_text" aria-describedby="club_id_away_alt_textHelp" value="{{ $fixture->club_id_away_alt_text }}">
