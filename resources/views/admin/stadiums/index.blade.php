                ...
                <tr>
                    ...
                    <td class="align-middle">
                        ...
                        @else
                            {{ $stadium->name }}
                        @endcan
                        <br>Mannschaften zugeordnet: {{ $stadium->clubs->count() }}
                    </td>
                    ...
                    <td class="align-middle">
                        @can('read stadium')
                            <!-- display details -->
                            <a class="btn btn-secondary btn-sm" href="{{ route('stadiums.show', $stadium) }}" title="Spielort anzeigen">
                                <span class="fa fa-search-plus"></span>
                            </a>
                        @endcan
                        @can('update stadium')
                            <!-- edit -->
                            <a class="btn btn-primary btn-sm" href="{{ route('stadiums.edit', $stadium) }}" title="Spielort bearbeiten">
