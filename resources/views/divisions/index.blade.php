                    ...
                    <ul class="list-unstyled">
                        @foreach ($fixtures->sortBy('datetime') as $fixture)
                            ...
                            @if ($fixture->rescheduledTo)
                                <div class="row">
                                    <div class="col">
                                        <small><span class="text-warning">Paarung wurde {{ $fixture->rescheduledTo->rescheduledBy ? "von ".$fixture->rescheduledTo->rescheduledBy->name_short : null }}</span> Siehe <a href="{{ route('frontend.fixtures.show', $fixture) }}" title="Matchdetails">Spiel</a>  für Details.</small>
                                    </div>
                                </div>
                            @endif
                            </li>
